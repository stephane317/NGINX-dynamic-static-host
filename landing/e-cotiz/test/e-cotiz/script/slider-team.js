...
new Slider(document.querySelector('#sliderManagement'), {
  slidesToScroll: 1,
  slidesVisible: 4,
  infinite: true
})

new Slider(document.querySelector('#sliderSales'), {
  slidesToScroll: 1,
  slidesVisible: 4,
  infinite: true
})

new Slider(document.querySelector('#sliderSupport'), {
  slidesToScroll: 1,
  slidesVisible: 4,
  infinite: true
})

new Slider(document.querySelector('#sliderTech'), {
  slidesToScroll: 1,
  slidesVisible: 4,
  infinite: true
})

new Slider(document.querySelector('#sliderMarketing'), {
  slidesToScroll: 1,
  slidesVisible: 4,
  infinite: true
})
...
let managementElt = document.querySelector('#managementDiv')
let salesElt = document.querySelector('#salesDiv')
let supportElt = document.querySelector('#supportDiv')
let techElt = document.querySelector('#techDiv')
let marketingElt = document.querySelector('#marketingDiv')

function toggleSliderManagement() {
    managementElt.style.display = "block"
    salesElt.style.display = "none"
    supportElt.style.display = "none"
    techElt.style.display = "none"
    marketingElt.style.display = "none"
}

function toggleSliderSales() {
    managementElt.style.display = "none"
    salesElt.style.display = "block"
    supportElt.style.display = "none"
    techElt.style.display = "none"
    marketingElt.style.display = "none"
 }

function toggleSliderSupport() {
    managementElt.style.display = "none"
    salesElt.style.display = "none"
    supportElt.style.display = "block"
    techElt.style.display = "none"
    marketingElt.style.display = "none"
}

function toggleSliderTech() {
    managementElt.style.display = "none"
    salesElt.style.display = "none"
    supportElt.style.display = "none"
    techElt.style.display = "block"
    marketingElt.style.display = "none"
}

function toggleSliderMarketing() {
    managementElt.style.display = "none"
    salesElt.style.display = "none"
    supportElt.style.display = "none"
    techElt.style.display = "none"
    marketingElt.style.display = "block"
}